    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                ...
                $(button).html('<i class="bi bi-check-circle-fill"></i> Siguiendo')
            } else {
                $(button).attr('disabled', false);

                alert('Algo va mal, intentelo más tarde');
            }
        }
    });
});
...
$(".unfollowbtn").click(function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status) {
                $(button).data('userId', 0);
                $(button).html('<i class="bi bi-check-circle-fill"></i> Dejado de seguir')
            } else {
                $(button).attr('disabled', false);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                ...
                $("#sra").html('<p class="text-center text-muted">No se encontró al usuario</p>');
