<div class="login">
    <div class="col-lg-4 col-md-8 col-sm-12 bg-white border rounded p-4 shadow-sm">
        ...
        <form method="post" action="assets/php/actions.php?<?= $action ?>">
            ...
            ?>
                <p>Introduce el código de 6 digitos - <?= $_SESSION['forgot_email'] ?></p>
            ...
            ?>
                <p>Introduce tu nueva contraseña - <?= $_SESSION['forgot_email'] ?></p>
                <div class="form-floating mt-1">
            ...
            <a href="?login" class="text-decoration-none mt-5"><i class="bi bi-arrow-left-circle-fill"></i> Volver a inicio de sesión</a>
        </form>
    </div>
</div>