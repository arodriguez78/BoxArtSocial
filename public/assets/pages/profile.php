...
<div class="container col-md-9 col-sm-11 rounded-0">
                    ...
                    ?>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#chatbox" onclick="popchat(<?= $profile['id'] ?>)"><i class="bi bi-chat-fill"></i> Enviar un mensaje</a></li>
                    ...
                    <div class="d-flex gap-2 align-items-center my-1">
                        ...
                        <?php
                            ...
                            <div class="alert alert-danger" role="alert">
                                <i class="bi bi-x-octagon-fill"></i> @<?= $profile['username'] ?> Te ha bloqueado! <!-- Esto es muy tóxico -->
                            </div>
    ...
    ?>
        <div class="alert alert-secondary text-center" role="alert">
            <i class="bi bi-x-octagon-fill"></i> No puedes ver los post de este usuario
        </div>
    <?php

    } else if (count($profile_post) < 1) {
        echo "<p class='p-2 bg-white border rounded text-center my-3'>No hay ninguna publicación</p>";
    }
    ?>
                            ...
                            <div class="col-md-4 col-sm-12 d-flex flex-column">
                                ...
                                ?>
                                    <div class="text-center p-2">
                                        Si quieres comentar sigue a este usuario</div>
